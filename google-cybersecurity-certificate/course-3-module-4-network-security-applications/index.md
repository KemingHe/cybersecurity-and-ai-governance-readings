...
> Retrieved on 2026-01-05 by Keming He from [Google Cybersecurity Certificate - Course 3 - Module 4 - Network Security Applications](https://www.coursera.org/learn/networks-and-network-security/supplement/U4ch1/network-security-applications)
...
> ![Figure 1](./firewall-ids-ips-comparison.png)
>
> Figure 1. The placement differences between a firewall, IPS, and IDS in the network
...
> ![Figure 2](./firewall-in-network.png)
>
> Figure 2. A firewall circled by dashes, protecting the internal network from internet traffic that comes in through the modem
...
> ![Figure 3](./ids-in-network.png)
>
> Figure 3. An IDS circled above an image of a switch, which rests between a firewall and the network
...
> ![Figure 4](./ips-in-network.png)
>
> Figure 4. An IPS situated between a firewall and the internal network
...
### [Chronicle](https://docs.cloud.google.com/chronicle/docs/overview)
...
> ![Figure 5](./chronicle-dashboard.png)
>
> Figure 5. Image of the Chronicle dashboard
